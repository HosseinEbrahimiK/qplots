...
Qplots provides a function to plot variables of a data frame so that basic statistics of variables can be obtained immediately.
  - `diquick_dist()`: plots density distribution of numeric variables or barplot of category/factor variables in a data frame.
